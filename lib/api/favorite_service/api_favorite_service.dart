...
class ApiFavoriteService {
  ...
  static Future<Map<String, dynamic>> createFavorite(String postId) async {
    try {
      ...
      const url = '${AppConfig.apiUrl}/favorites';
  ...
  static Future<Map<String, dynamic>?> getMyFavoritePost(
    ...
    try {
      ...
      String? userId = userAuthData.userId;
      final url =
          '${AppConfig.apiUrl}/favorites?userId=$userId&page=$page&size=$size';
